// tulisan EGG akan berubah ukuran sesuai dengan lebar layar (lg,md,sm)
// icon yg digunakan adalah shopping cart
// svg nya dapat diberikan class tailwindcss
...
const Hero = () => {
  return (
    <div className="bg-white h-screen flex flex-col justify-center items-center">
      {/* Nama web */}
      <h1 className="lg:text-9xl md:text-7xl sm:text-5xl text-3xl font-black mb-14">ENDOK</h1>
      {/* Tombol order */}
